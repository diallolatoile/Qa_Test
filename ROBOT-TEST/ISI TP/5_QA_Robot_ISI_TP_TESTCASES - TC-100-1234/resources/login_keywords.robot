...
Vérifier message de réussite login
    ...
    ...    ELSE IF    '${VALID_MSG_LOGIN_en}' in '${page_text}'    Log    Message trouvé en anglais : ${VALID_MSG_LOGIN_en}    console=True
    ...    ELSE IF    '${VALID_MSG_LOGIN_fr}' in '${page_text}'    Log    Message trouvé en français : ${VALID_MSG_LOGIN_fr}    console=True
    ...    ELSE    Fail    Aucun des messages attendus ('${expected_msg}', '${VALID_MSG_LOGIN_en}', '${VALID_MSG_LOGIN_fr}') n'a été trouvé.
