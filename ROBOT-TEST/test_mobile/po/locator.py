...
PRODUCTS_LIST_PAGE  =   "//android.widget.FrameLayout[@resource-id=\"android:id/content\"]/android.widget.FrameLayout/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View[2]"
NEW_ADDED_PRODUCT   =   "//android.widget.ImageView[@content-desc=\"Fjallraven - Foldsack No. 1 Backpack, Fits 15 Laptops 109.95 $\"]"